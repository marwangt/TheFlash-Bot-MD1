...
if (db.data.chats[m.chat].reaction && m.text.match(/(مروان|هلا|مرحبا|212657035661|زيك|اخبارك|عامل ايه|المطور|حلو|اه|لا|خلااص|اوك|مشكل)/) {
let emot = pickRandom(["🫐", "🩵", "🍇", "🍓", "🍉",])
...
"thumbnail": apii.data, 
"title": [wm, '🌚 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 🫐', '『𝑅𝐼𝑇𝐴﹝🍇﹞𝐵𝛩𝑇』'].getRandom(),
